  ...
  return (
    <section className="section-container ">
          <section className="bg-[#E7E4DE] sm:py-[120px] py-20 max-sm:py-12 sm:px-24 px-8 max-xsm:px-5  rounded-2xl flex max-slg:flex-col-reverse justify-between gap-24 max-slg:gap-10">
                 ...
                 <article>
                      <p className="sm:text-lg leading-[29.92px] slg:mt-9 max-slg:text-center">Whether you're a company looking to scale your team or a talented professional seeking new opportunities, we invite you to join us on our journey</p>
                 </article>
          </section>
  </section>
  )
