...
const Header = () => {
  return (
   <header className='px-[100px] max-xlg:px-[50px] max-lg:px-9 max-sm:px-4  flex max-slg:flex-col pt-16 max-lg:pt-6 justify-between relative max-lg:top-[96px]'>
        <section className='flex flex-col slg:pt-[84px]'>
            <h1 className='text-[48px] font-extrabold max-w-[700px] lg:text-[44px] max-sm:text-[36px]'>Welcome to Frack: Your Fractional Talent Solution</h1>
        ...
        <section>
        <div className=' basis-[1/2] slg:max-w-[300px]'>
